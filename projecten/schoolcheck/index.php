                ...
                <div class="step-wrapper">
                    ...
                    <div class="school-list-wrapper">
                        ...
                        <div class="school-list-email-wrapper">
                            Stuur hier je voorkeurlijst naar jouw e-mail!
                            <?php
                                  $name = $_POST['name'];
                                  $to  = $_POST['email'];
        
                                // subject
                                $subject = 'Favorietenlijst schoolcheck';
        
                                // message
                                $message = "
                                  Beste $name, \n
                                  Hierbij uw favorietenlijst:
                                ";
                        ...
                        <form class="mail_form" action="index.php" method="post">
                          <input type="text" name="name" placeholder="Uw naam"><br>
                          <input type="email" name="email" placeholder="Uw email"><br>
                          <input type="submit" name="submit" value="Verstuur je voorkeurlijst!">
                        </form>

                            <div class="school-list-email-icon"><i class="fa fa-envelope-o" aria-hidden="true"></i></div>
                        </div>
                    </div>
                </div>
            </div>
